...
function SelectedWork() {
  return (
    <>
      <div className="Responsive-SW text-white w-[68%] mx-auto min-h-[100vh] pt-10 mb-10">
        <p className="Responsive-SW-Title inter-font-style-1 text-white items-center flex gap-[15px] text-[50px]">
          Selected Work
        </p>
        <div className="mt-4">
          <div className="Responsive-SW-Div w-full snap-center min-h-[68vh] flex max-h-[560px] overflow-hidden pl-14 pt-14 bg-neutral-900 rounded-[40px] border-[1px] border-neutral-700 mb-7">
            <div>
              <img
                src={Logo1}
                alt=""
              ...
              />
              <p className="Responsive-SW-SubTitle inter-font-style-1 text-white items-center mt-2 w-[520px] leading-[55px] flex gap-[15px] text-[40px]">
                TuneUp Technologies - Educational Website
              </p>
              <p className="Responsive-SW-Para Responsive-SW-Para text-neutral-500 w-[520px]">
            ...
            <div>
              <img
                src={TuneUp}
                alt=""
                className="Responsive-SW-Img min-w-[650px] mt-[-10px] ml-[20px]"
              />
            </div>
          </div>
          <div className="Responsive-SW-Div w-full snap-center min-h-[68vh] flex max-h-[560px] overflow-hidden pl-14 pt-14 bg-neutral-900 rounded-[40px] border-[1px] border-neutral-700 mb-7">
            <div>
              ...
              <p className="Responsive-SW-Para text-neutral-500 w-[520px]">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rerum
                animi, eaque quae, laudantium accusamus ullam facilis, facere
                nihil nam minima delectus alias in architecto recusandae
                reprehenderit qui error amet! Provident.
            ...
            <div>
              <img
                src={KMM}
                alt=""
                className="Responsive-SW-Img min-w-[780px] mt-[-60px] ml-[-10px]"
              />
            </div>
          </div>
          <div className="Responsive-SW-Div w-full snap-center min-h-[68vh] flex max-h-[560px] overflow-hidden pl-14 pt-14 bg-neutral-900 rounded-[40px] border-[1px] border-neutral-700 mb-7">
          ...
          <div className="Responsive-SW-Div w-full snap-center min-h-[68vh] flex max-h-[560px] overflow-hidden pl-14 pt-14 bg-neutral-900 rounded-[40px] border-[1px] border-neutral-700 mb-7">
            ...
            <div>
              <img
                src={Pexels}
                alt=""
                className="Responsive-SW-Img min-w-[650px] mt-[-20px] ml-[20px] -rotate-3"
              />
            </div>
          </div>
        </div>
